 ...
 */
public class EditGathers extends javax.swing.JFrame {
    private GathersModel gathers;
    GathersService gathersService;

    /** Creates new form EditGathers */
    public EditGathers(String pid, String tid) {
        gathersService = new GathersService();
        gathers = gathersService.getGathers(pid, tid);
        initComponents();
        setLocationRelativeTo(null);
        
        pidTextField.setText(gathers.getpID());
        tidTextField.setText(gathers.gettID());
        nameTextField.setText(gathers.getName());
        locationTextField.setText(gathers.getLocation());
        dateTextField.setText(gathers.getDate());
    }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(locationTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
                            .addComponent(tidTextField, javax.swing.GroupLayout.Alignment.LEADING)))
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        // TODO add your handling code here:
        gathers.setpID(pidTextField.getText());
        gathers.setName(nameTextField.getText());
        gathers.setDate(dateTextField.getText());
        gathers.settID(tidTextField.getText());
        gathers.setLocation(locationTextField.getText());

        gathersService.updateGathers(gathers);
