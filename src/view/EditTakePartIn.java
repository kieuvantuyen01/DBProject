 ...
 */
public class EditTakePartIn extends javax.swing.JFrame {
    private TakePartInModel takePartIn;
    TakePartInService takePartInService;

    /** Creates new form EditTakePartIn */
    public EditTakePartIn(String tid, String mid, String pid) {
        takePartInService = new TakePartInService();
        takePartIn = takePartInService.getTakePartIn(tid, mid, pid);
        initComponents();
        setLocationRelativeTo(null);
        
        pidTextField.setText(takePartIn.getpID());
        tidTextField.setText(takePartIn.gettID());
        midTextField.setText(takePartIn.getmID());
    }
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        takePartInService.updateTakePartIn(takePartIn);
